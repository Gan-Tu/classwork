...
inst_needs_relocation:
	srl $t0, $a0, 26
	beq $t0, $0, inst_needs_relocation_false
...
relocate_inst:
	...
	move $t0, $v0 # store the address for the symbol name
	...
	move $t0, $v0 # gets target address relocated

	lw $a0, 12($sp)
	srl $t1, $a0, 26
	li $t2, 0x2
	beq $t1, $t2, relocate_inst_j
	li $t2, 0x3
	beq $t1, $t2, relocate_inst_j
relocate_inst_i:
	move $v0, $a0
