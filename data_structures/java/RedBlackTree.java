...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> buildRedBlackTree(BTree.Node<T> r) {
        ...
        RBTreeNode<T>[] children = new RBTreeNode[r.getChildrenCount()];
        for (int i = 0; i < children.length; i++) {
            children[i] = buildRedBlackTree(r.getChildAt(i));
        }
        int itemCount = r.getItemCount();
        if (itemCount == 1) {
            return new RBTreeNode<T>(true, r.getItemAt(0), children[0], children[1]);
        } else if (itemCount == 2) {
            RBTreeNode<T> right = 
                new RBTreeNode<T>(false, r.getItemAt(1), children[1], children[2]);
            return new RBTreeNode<T>(true, r.getItemAt(0), children[0], right);
        } else {
            RBTreeNode<T> left = 
                new RBTreeNode<T>(false, r.getItemAt(0), children[0], children[1]);
            RBTreeNode<T> right = 
                new RBTreeNode<T>(false, r.getItemAt(2), children[2], children[3]);
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        ...
        RBTreeNode<T> right = new RBTreeNode<T>(false, node.item, node.left.right, node.right);
        return new RBTreeNode<T>(node.isBlack, node.left.item, node.left.left, right);
    }
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        ...
        RBTreeNode<T> left = new RBTreeNode<T>(false, node.item, node.left, node.right.left);
        return new RBTreeNode<T>(node.isBlack, node.right.item, left, node.right.right);
    }
