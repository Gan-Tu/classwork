 ...
 *  the integers 1-N, each partition is represented by a unique integer in
 *  the range 1-N, called its representative.
 *  @author Gan Tu
 */
public class UnionFind {
    ...
    /** The representative array for the parents of union find. */
    private int[] _set;
}
