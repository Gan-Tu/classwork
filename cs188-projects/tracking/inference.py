    ...
    def elapseTime(self, gameState):
        ...
        for p in self.allPositions:
            ...
            for key in newPosDist.keys():
                beliefs[key] += self.beliefs[p] * newPosDist[key]
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(self.numParticles):
            self.particles.append(legal[i % totalNum])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        if distribution.total() == 0:
            ...
            newParticles = [distribution.sample() for _ in range(self.numParticles)]
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        legal = self.legalPositions
        allPairs = list(itertools.product(legal, repeat=self.numGhosts))
        random.shuffle(allPairs)
        totalNum = len(allPairs)
        for i in range(self.numParticles):
            self.particles.append(allPairs[i % totalNum])
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            oldParticleList = list(oldParticle)  # A list of ghost positions
    
            # now loop through and update each entry in newParticle...
            newParticle = []
            for i in range(self.numGhosts):
                newPosDist = self.getPositionDistribution(gameState, oldParticleList, \
